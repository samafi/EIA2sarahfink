...
(function (Abschlussarbeit2) {
    class Tree {
        drawTrunk() {
            ...
            Abschlussarbeit2.crc2.lineTo(this.x, this.y);
            Abschlussarbeit2.crc2.lineTo(this.x + 50, this.y);
            Abschlussarbeit2.crc2.lineTo(this.x + 50, this.y + 50);
        ...
        draw() {
            ...
            Abschlussarbeit2.crc2.lineTo(this.x, this.y - 200);
            Abschlussarbeit2.crc2.lineTo(this.x - 60, this.y - 200);
            Abschlussarbeit2.crc2.lineTo(this.x + 25, this.y - 300);
            Abschlussarbeit2.crc2.lineTo(this.x + 110, this.y - 200);
            Abschlussarbeit2.crc2.lineTo(this.x + 50, this.y - 200);
